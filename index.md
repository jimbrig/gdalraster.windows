...
- build [`gdalraster`](https://firelab.github.io/gdalraster/) from
  source against it
...
release tag. See the [Architecture
article](https://docs.jimbrig.com/gdalraster.windows/articles/architecture.html)
...
- **[MinGW-w64](https://www.mingw-w64.org/)**: GCC-based Windows
  compiler toolchain for native `.exe`/`.dll`.
- **[MSYS2](https://www.msys2.org/)**: package manager + shell
  environment used to assemble toolchains and dependencies (`pacman`).
- **[UCRT64](https://www.msys2.org/docs/environments/)**: MSYS2
  toolchain target using Microsoft’s Universal CRT.
...
[ntldd](https://github.com/LRN/ntldd) (`ntldd -R`), copies required
UCRT64 DLLs into the bundle, and fails when unresolved external
...
- [firelab/gdalraster#826](https://github.com/firelab/gdalraster/issues/826)
  — algorithm-registry failure mode on Windows
- [firelab/gdalraster#858](https://github.com/firelab/gdalraster/issues/858)
  — enabling muparser in the Rtools GDAL build
